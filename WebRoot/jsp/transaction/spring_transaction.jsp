...
<title>spring_transaction</title>
...
spring_transaction.jsp
<div>
<input type="button" name="test_transaction" value="test_transaction"/>
<input type="button" name="insertDepartment" value="insertDepartment"/>
</div>
</div>
</body>
...
<script>
      $(document).ready(function(){
        ...
        $("input[name=test_transaction]").click(function(){
        	$.ajax({
        		url : "/alarm/rest/detecotr/transaction.htm",
        		type : "post",
        		dataType : "json",
        		...
        		error : function(jqXHR, textStatus, errorThrown){
        			Utils.ajaxError(jqXHR, textStatus, errorThrown);
        		}
        	});
        });
        
        $("input[name=insertDepartment]").click(function(){
        	$.ajax({
        		url : "/alarm/rest/detecotr/insertDepartment.htm",
        		type : "post",
        		dataType : "json",
        		success : function(data, textStatus, jqXHR){
        			alert(data.retCode);
